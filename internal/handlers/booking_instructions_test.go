...
func TestBuildTripContext_IncludesBookingInstructions(t *testing.T) {
	ctx := buildTripContext("Japan Trip", "Two weeks in Japan", "JP", nil, "", "", "planning", []string{"food", "culture"}, nil, nil, 0, tier.Free)
...
func TestBuildTripContext_ProTier(t *testing.T) {
	ctx := buildTripContext("Japan Trip", "Two weeks in Japan", "JP", nil, "", "", "planning", []string{"food", "culture"}, nil, nil, 0, tier.Pro)
...
func TestBuildTripContext_Empty_ReturnsEmpty(t *testing.T) {
	ctx := buildTripContext("", "", "", nil, "", "", "", nil, nil, nil, 0, tier.Free)
	if ctx != "" {
...
func TestBuildTripContext_IncludesBookings(t *testing.T) {
	...
	ctx := buildTripContext("Japan Trip", "", "JP", nil, "", "", "planning", nil, nil, bookings, 0, tier.Free)
...
func TestBuildTripContext_IncludesCollaborators(t *testing.T) {
	ctx := buildTripContext("Japan Trip", "", "JP", nil, "", "", "planning", nil, nil, nil, 3, tier.Free)
...
func TestBuildTripContext_IncludesStatus(t *testing.T) {
	ctx := buildTripContext("Japan Trip", "", "JP", nil, "", "", "active", nil, nil, nil, 0, tier.Free)
