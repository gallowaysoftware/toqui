...
VALUES (sqlc.arg(user_id), sqlc.arg(stripe_customer_id), sqlc.arg(stripe_subscription_id), sqlc.arg(tier), sqlc.arg(status), sqlc.arg(current_period_start), sqlc.arg(current_period_end))
