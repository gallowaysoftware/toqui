    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-8">
      <div className="max-w-2xl text-center">
        ...
        <div className="flex gap-4 justify-center">
          ...
          <button
            onClick={login}
            className="rounded-full border border-[var(--color-border-strong)] px-6 py-3 text-[var(--color-text-secondary)] font-medium hover:bg-[var(--color-surface-tertiary)] transition-colors"
          >
            {tc("signIn")}
          </button>
        </div>
