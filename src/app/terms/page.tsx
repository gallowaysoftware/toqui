      ...
      <div className="mx-auto max-w-3xl px-6 py-16">
        ...
        <article className="prose prose-neutral dark:prose-invert max-w-none">
          ...
          <section className="space-y-4 text-[var(--color-text-secondary)]">
            ...
            <p>
              By accessing or using Toqui (&quot;the Service&quot;), operated by
              Galloway Software (&quot;we,&quot; &quot;us,&quot; or
            ...
            <p>
              You must be at least 18 years old to use Toqui. By using the
            ...
            <p>
              Toqui is an AI-powered travel planning application that helps you
              create trips, generate itineraries, discover destinations, and find
              booking recommendations through conversational AI. The Service uses
              artificial intelligence to generate responses and suggestions.
            </p>
            ...
            <p>
              Toqui uses AI language models to generate travel recommendations,
              itineraries, and conversational responses. You acknowledge and agree
              that:
            </p>
            <ul className="list-disc pl-6 space-y-1">
              <li>
                AI-generated content may contain inaccuracies, outdated
                information, or errors
              </li>
              <li>
                Recommendations are suggestions only and do not constitute
                professional travel advice
              </li>
              <li>
                You are responsible for verifying all information before making
                travel decisions, including prices, availability, visa
            ...
            <p>
              ...
              the security of your Google account. We are not liable for
              unauthorized access resulting from compromised third-party
              credentials.
            </p>
            ...
            <p>
              Toqui may display booking recommendations that include affiliate
              links. When you make a purchase through these links, we may earn a
              commission at no additional cost to you. Affiliate relationships do
              not influence recommendations for Trip Pro users. Free-tier
              recommendations may prioritize affiliate partners.
            </p>
            <p>
              Bookings are completed directly with third-party providers (e.g.,
              Booking.com, GetYourGuide). We are not a party to those
              transactions and are not responsible for the services provided by
              third parties.
            </p>
            ...
            <p>
              Toqui offers free and paid tiers. Paid features (Trip Pro, Annual
              Pass) are one-time purchases — there are no recurring subscriptions.
              All purchases are final unless required otherwise by applicable law.
              Pricing is displayed at the time of purchase.
            </p>
            ...
            <p>
              The Toqui application, including its design, code, and branding, is
              owned by Galloway Software. AI-generated content created for you
              (itineraries, recommendations, etc.) may be used by you for personal
              purposes. You retain ownership of any content you provide to the
              Service.
            </p>
            ...
            <p>
              To the maximum extent permitted by law, Galloway Software is not
            ...
            <p>
              ...
              error-free, or that AI-generated content will be accurate or
              complete.
            </p>
            ...
            <p>
              ...
              material changes via the application or email. Continued use of the
            ...
            <p>
              These Terms are governed by the laws of Canada. Any disputes will be
