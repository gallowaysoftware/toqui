...
5. **Booking recommendations**: Ask about guided tours at Delphi with an archaeologist guide (not a generic tour guide). The AI should recommend specific named operators and understand the distinction between academic and tourist-level tours — without emitting a phantom `recommend_booking` tool call or fabricating booking links.
