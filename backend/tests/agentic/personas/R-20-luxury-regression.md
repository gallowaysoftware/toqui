...
3. **Booking recommendations**: Ask the AI to recommend overwater villas in the Maldives and a helicopter tour in Dubai. Expect specific named resorts/operators appropriately positioned for ultra-luxury, booked directly with the provider — no phantom `recommend_booking` tool calls, no fabricated links, no affiliate disclosures.
